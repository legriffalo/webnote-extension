...
// state stores current options as well as layers that have been drawn
// Layers are collections of paths and their data a new layer can be voluntarily started
// or starts when screen dimensions are changed
// Default layer name will be domain + resolution + int starting at 1
...
chrome.runtime.sendMessage(
  ...
  // start new layer and give it name
);
